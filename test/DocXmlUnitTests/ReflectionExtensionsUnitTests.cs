...
namespace DocXmlUnitTests
{
    ...
    public class ReflectionExtensionsUnitTests
    {
        ...
        [DataRow(typeof(MethodsReflectionClass), nameof(MethodsReflectionClass.MethodWithRefParam), "(int& refParam)")]
        [DataRow(typeof(MethodsReflectionClass), nameof(MethodsReflectionClass.MethodWithOutParam), "(int& outParam)")]
        [DataRow(typeof(MethodsReflectionClass), nameof(MethodsReflectionClass.MethodWithInParam), "(int& inParam)")]
        [DataRow(typeof(MethodsReflectionClass), nameof(MethodsReflectionClass.MethodWithNullableParam), "(int? nullableParam)")]
        [DataRow(typeof(MethodsReflectionClass), nameof(MethodsReflectionClass.MethodWithNullableInParam), "(int?& nullableInParam)")]
        ...
        [DataRow(typeof(MethodsReflectionClass), nameof(MethodsReflectionClass.GetTuple2Ref), "((string Three, string Four)& tupleParam)")]
        [DataRow(typeof(MethodsReflectionClass), nameof(MethodsReflectionClass.GetTuple3), "((string, string) unnamedTupleParam)")]
        [DataRow(typeof(MethodsReflectionClass), nameof(MethodsReflectionClass.GetTuple3Ref), "((string, string)& unnamedTupleParam)")]
